...
export default function BudgetItemsScreen({ navigation, route }) {
  ...
  const [projectBudget, setProjectBudget] = useState([
    {
      id: 1,
      description: 'Begining of the Budget Item descripton is coming',
      amount: 562,
      quantity: 1,
    },
    {
            ...
            <View style={[s.cardContainer, g.containerBetween]}>
              <View style={{ flex: 1 }}>
                ...
                <View style={[s.cardRowBetween, { paddingBottom: 15, paddingLeft: 10 }]}>
                  ...
                  <Text style={[g.gCardStatus, { backgroundColor: '#F2F6FF', color: '#9CA2AB' }]}>
  ...
  useEffect(() => {
    if (isFocused) {
      dispatch(setPlus())
      dispatch(setPlusDestination('ProjectAdd'))
    }
  }, [isFocused])
      ...
      <View style={[g.outerContainer, g.spaceBelow]}>
        <View style={s.outerPadding}>
          ...
          <View style={s.headerContainer}>
            ...
            <CText style={[g.title3, s.textColor]}>{'Project 1'}</CText>
        ...
        {!loading && projectBudget.length == 0 && (
          <Text>
            No Project Budget to show. Please create your new project by pressing the plus button.
          </Text>
        )}
