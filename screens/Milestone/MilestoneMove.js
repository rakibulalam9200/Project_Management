...
export default function MilestoneMoveScreen({ navigation, route }) {
  ...
  const attemptMove = () => {
    if (
      hasTaskNameErrors(milestoneName, setErrorMessages) ||
      ...
      api.milestone.getMilestone(id)
        .then((res) => {
          if (res.success) {
            ...
            //console.log('Here ->>', res.milestone)
            ...
            <View style={{}}>
              ...
              <View style={{ backgroundColor: colors.SEC_BG, paddingBottom: 20, paddingHorizontal: 16, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }}>
                ...
                <View style={{ marginTop: 10, }}>
                  <Text style={{ fontSize: 16 }}>Please, select Project where to move</Text>
                </View>
