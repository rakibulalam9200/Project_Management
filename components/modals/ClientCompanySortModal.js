...
const ClientCompanySortModal = ({ children, sortBy, setSortBy, visibility, setVisibility, onApply = null }) => {
...
export default ClientCompanySortModal
