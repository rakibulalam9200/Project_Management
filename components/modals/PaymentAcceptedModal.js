    ...
    return (
        ...
        <View style={[styles.modalOuterContainer]}>
            ...
            <View style={[styles.form]}>
                    ...
                    <Text style={[styles.subHeading]}>You have successfully subscribed to the plan of your organization</Text>
                    <TouchableOpacity
                        onPress={onPressOk}
                        style={[styles.button]}
                    >
...
export default PaymentAcceptedModal
