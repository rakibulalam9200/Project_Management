...
const MilestoneCustomizationModal = ({
  openModal,
  setOpenModal,
  expandView,
  setExpandView,
          ...
          <View style={[styles.modalContent]}>
            ...
            <View style={[styles.listItemContainer, { width: '100%', marginVertical: 10 }]}>
              ...
              <CButton
                ...
                onPress={() => {
                  closeModal()
                  setItem('milestoneItemView', itemView)
                  setItem('milestoneCollapseView', collapseView)
...
export default MilestoneCustomizationModal
