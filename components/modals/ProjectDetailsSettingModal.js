...
import TemplateIcon from '../../assets/svg/create-template.svg'
import DeleteIcon from '../../assets/svg/delete-2.svg'
import EditIcon from '../../assets/svg/edit.svg'
import CButtonInput from '../common/CButtonInput'
import IconWrap from '../common/IconWrap'

export default function ProjectDetailsSettingsModal({
  children,
  visibility,
  setVisibility,
  navigation,
      ...
      <View style={[s.modalOuterContainer]}>
        <View style={s.modalContainer}>
          ...
          <TouchableOpacity style={[s.settingsItemContainer]}>
            <Text style={s.settingsItemText}>Create Template</Text>
            <IconWrap outputRange={iconWrapColors}>
              <TemplateIcon />
            </IconWrap>
          </TouchableOpacity>
