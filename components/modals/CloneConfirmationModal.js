...
export default function CloneConfirmationModal({
  children,
  confirmationMessage = 'Do you want to Clone projects? Projects will be clone with same state with its childs',
  visibility,
  setVisibility,
  onClone = null,
  setSelectable = null,
        ...
        <View style={s.modalContainer}>
          ...
          <View style={g.containerBetween}>
            ...
            <CButtonInput
              label="Clone"
              onPress={onClone}
              style={[s.cloneButton, btnLoader && { paddingHorizontal: 35 }]}
              loading={btnLoader}
            />
          </View>
        </View>
